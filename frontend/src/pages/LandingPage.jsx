  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      particles.forEach((p) => {
        ...
        ctx.fillStyle = `rgba(123, 63, 242, ${p.a})`
        ctx.fill()
      })
    ...
    <div className="overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-24 pb-16 grid-bg">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4">
          ...
          >
            <Link
              to="/upload"
              className="btn-glow px-8 py-4 rounded-xl text-base font-bold text-white inline-flex items-center gap-2"
            >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="glass-card overflow-hidden">
            ...
            <div className="px-6 pb-6">
              <Link
                to="/upload"
                className="btn-glow flex items-center justify-center gap-2 w-full py-3 rounded-xl font-bold text-white text-sm"
              >
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {STEPS.map((step, i) => (
              ...
              >
                <div className="absolute -top-4 -left-4 w-8 h-8 rounded-full bg-primary text-white text-xs font-black flex items-center justify-center border-2 border-dark">
                  {step.n}
                </div>
      ...
      <section className="py-24 px-4 relative overflow-hidden">
        ...
        <div className="relative max-w-2xl mx-auto text-center">
          ...
          <Link
            to="/upload"
            className="btn-glow inline-flex items-center gap-3 px-10 py-4 rounded-xl text-lg font-bold text-white animate-glow-pulse"
          >
            <Target className="w-5 h-5" />
